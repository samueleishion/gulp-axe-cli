  ...
  return through.obj(function (file, enc, cb) {
    ...
    try {
      (() => {
        ...
        exec('axe "' + url + '" --tags wcag2a,wcag2aa', function(err, stdout, stderr) {
          if (stdout.indexOf('Accessibility issues detected') > 0) {
            gutil.log(gutil.colors.cyan(PLUGIN_NAME), gutil.colors.red("[ERROR]"), 'Error testing ' + url);
            throw stdout;
          } else if (stdout.indexOf('0 violations found!') > 0) {
